...
/**
 * Class Name: home_side_menu_nav_walker
...
class home_side_menu_nav_walker extends Walker_Nav_Menu {
    ...
    function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
        ...
        if (strcasecmp($item->title, 'divider')) {
            ...
            $classes[] = 'side-menu-item-' . $item->ID;
            $class_names = join( ' ', apply_filters( 'nav_menu_css_class', array_filter( $classes ), $item, $args ) );

            if ($args->has_children && $depth > 0) {
                $class_names .= ' side-popout-submenu';
            ...
            $id = apply_filters( 'nav_menu_item_id', 'side-menu-item-'. $item->ID, $item, $args );
            ...
            $attributes .= ($args->has_children)        ? ' data-toggle="popout" data-target="#" class="popout-toggle"' : '';
